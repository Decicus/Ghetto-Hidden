...
function GM:PlayerCanPickupWeapon(ply, wep)
   ...
   -- Unfinished part of Ghetto Hidden's "you cannot pickup any weapons" function.
   -- I'm not sure how it works, so I might have to make a table/list or something of all the weapons Hidden shouldn't be able to pickup.
   --[[
	for k, v in ipairs (player.GetAll()) do
		if v:IsRole(ROLE_TRAITOR) then
			if wep:GetClass() == "weapon_gh_rambo" then
			return true
			else
			return false
			end
