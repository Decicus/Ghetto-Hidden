...
SWEP.ViewModel			= "models/weapons/c_gh_claw.mdl"
SWEP.WorldModel			= "models/weapons/w_gh_claw.mdl"
SWEP.Weight			= 5
...
-- SWEP.InLoadoutFor = {ROLE_TRAITOR, ROLE_DETECTIVE}
